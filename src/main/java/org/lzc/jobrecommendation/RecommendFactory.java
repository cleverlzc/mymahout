package org.lzc.jobrecommendation;
...
public final class RecommendFactory {
    ...
    public static void statsEvaluator(RecommenderBuilder rb, DataModelBuilder mb, DataModel m, int topn) throws TasteException {
        ...
        System.out.printf("Recommender IR Evaluator: [Precision:%s,Recall:%s,F1Measure:%s,NormalizedDiscountedCumulativeGain:%s]\n", stats.getPrecision(), stats.getRecall(),stats.getF1Measure(),stats.getNormalizedDiscountedCumulativeGain());
    }
